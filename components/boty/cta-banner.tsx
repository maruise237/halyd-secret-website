      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <Reveal className="rounded-3xl p-8 sm:p-12 md:p-16 flex flex-col justify-center relative overflow-hidden min-h-[360px] sm:min-h-[400px] bg-gradient-to-br from-black via-[#1a1410] to-[#3d2c12]">
          <div className="relative z-10 text-left max-w-2xl">
            <h2 className="font-serif mb-6 sm:mb-8">
              <span className="block text-3xl sm:text-4xl md:text-5xl text-white mb-3 sm:mb-4">
                Réservez votre moment
              </span>
              <span className="block text-xl sm:text-2xl md:text-3xl text-gold">chez Halyd&apos;s Secret</span>
            </h2>
